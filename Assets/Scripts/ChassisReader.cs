...
public class ChassisReader : MonoBehaviour {
	...
	void Start () {
		...
		BarcodeScanner.StatusChanged += (sender, arg) => {
			TextHeader.text = "Item: " + BarcodeScanner.Status;
		};
	}
	...
	public void ClickStart()
	{
		...
		BarcodeScanner.Scan((barCodeType, barCodeValue) => {
			BarcodeScanner.Stop();
			TextHeader.text = " Item: " + barCodeValue;

			string codigodeChasis;
			codigodeChasis = barCodeValue.ToString();
			...
			dataCtrl.report.chassis.id = codigodeChasis;
		});
	}
